    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary card-outline">
                ...
                <!-- form start -->
                <form action="../../sistema/acesso/sAlterarDadosDoUsuario.php">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-1">
                                ...
                                <input type="text" class="form-control" id="nome" value="Kleber">
                            </div>
                            <div class="form-group col-md-1">
                                <label for="sobrenome">Sobrenome</label>
                                <input type="text" class="form-control" id="sobrenome" value="Pereira de Almeida">
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control" id="telefonePessoal" value="(47) 9 9611-5955">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="whatsappPessoal">WhatsApp Pessoal</label>
                                <input type="text" class="form-control" id="whatsappPessoal" value="(47) 9 9611-5955">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="emailPessoal">Email Pessoal</label>
                                <input type="text" class="form-control" id="emailPessoal" value="kleberjlle@gmail.com" <?php echo $_SESSION['permissao'] > 4 ? '' : 'disabled=\"\"'; ?>>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" <?php echo $_SESSION['permissao'] > 2 ? '' : 'disabled=\"\"'; ?>>
                                        ...
                                        <option>Agricultura e Pesca</option>
                                        <option>Assistência Social</option>
                                        <option>Chefia de Gabinete do Prefeito</option>
                                        <option>Controladoria Interna</option>
                                        <option>Desenvolvimento Social e Econômico</option>
                                        <option>Educação</option>
                                        <option>Esporte e Lazer</option>
                                        <option>Fazenda</option>
                                        <option>Infraestrutura</option>
                                        <option>Meio Ambiente</option>
                                        <option>Planejamento Urbano</option>
                                        <option>Procuradoria Jurídica</option>
                                        <option>Saúde</option>
                                        <option>Segurança Pública e Trânsito</option>
                                        <option>Turismo e Cultura</option>
                            ...
                            <div class="form-group col-md-2">
                                <label for="telefoneCorporativo">Telefone Corporativo</label>
                                <input type="text" class="form-control" id="telefoneCorporativo" value="(47) 9 8827-2029" <?php echo $_SESSION['permissao'] > 2 ? '' : 'disabled=\"\"'; ?>>
                            </div>
                            <div class="form-group col-md-2">
