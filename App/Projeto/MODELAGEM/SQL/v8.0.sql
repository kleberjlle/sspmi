...
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`secretaria` (
  ...
  INDEX `fk_secretaria_ambiente1_idx` (`ambiente_idambiente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`setor` (
  ...
  INDEX `fk_setor_secretaria1_idx` (`secretaria_idsecretaria` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`coordenacao` (
  ...
  INDEX `fk_coordenacao_secretaria1_idx` (`secretaria_idsecretaria` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`sistemaOperacional` (
  ...
  UNIQUE INDEX `idsistemaOperacional_UNIQUE` (`idsistemaOperacional` ASC) VISIBLE,
  UNIQUE INDEX `nomenclatura_UNIQUE` (`nomenclatura` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`equipamento` (
  ...
  INDEX `fk_equipamento_sistemaOperacional1_idx` (`sistemaOperacional_idsistemaOperacional` ASC) VISIBLE,
  INDEX `fk_equipamento_modelo1_idx` (`modelo_idmodelo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`etapa` (
  ...
  `equipamento_idequipamento` INT NULL,
  `usuario_idusuario` INT NULL,
  PRIMARY KEY (`idetapa`, `protocolo_idprotocolo`, `local_idlocal`, `prioridade_idprioridade`),
  UNIQUE INDEX `idetapa_UNIQUE` (`idetapa` ASC) VISIBLE,
  INDEX `fk_etapa_protocolo1_idx` (`protocolo_idprotocolo` ASC) VISIBLE,
  INDEX `fk_etapa_local1_idx` (`local_idlocal` ASC) VISIBLE,
  INDEX `fk_etapa_prioridade1_idx` (`prioridade_idprioridade` ASC) VISIBLE,
  INDEX `fk_etapa_equipamento1_idx` (`equipamento_idequipamento` ASC) VISIBLE,
  INDEX `fk_etapa_usuario1_idx` (`usuario_idusuario` ASC) VISIBLE,
