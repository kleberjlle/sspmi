...
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`protocolo` (
  ...
  `dataHoraAbertura` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`etapa` (
  ...
  `numero` INT NOT NULL,
  `dataHoraAbertura` DATETIME NOT NULL DEFAULT TIMESTAMP,
  `dataHoraEncerramento` DATETIME NULL,
  ...
  INDEX `fk_etapa_usuario1_idx` (`usuario_idusuario` ASC),
...
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`solicitacao` (
  ...
  `examinador` INT NULL,
  `dataHoraSolicitacao` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `dataHoraExaminador` DATETIME NULL,
...
-- -----------------------------------------------------
-- Table `itapoaap_sspmi`.`recuperarAcesso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`recuperarAcesso` (
  `idrecuperarAcesso` INT NOT NULL AUTO_INCREMENT,
  `dataHora` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `email` VARCHAR(100) NOT NULL,
  `chave` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`idrecuperarAcesso`),
  UNIQUE INDEX `idrecuperarAcesso_UNIQUE` (`idrecuperarAcesso` ASC))
ENGINE = InnoDB;
