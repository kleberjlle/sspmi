...
CREATE TABLE IF NOT EXISTS `itapoaap_sspmi`.`protocolo` (
  ...
  `nomeDoRequerente` VARCHAR(45) NULL,
  `sobrenomeDoRequerente` VARCHAR(100) NULL,
  `telefoneDoRequerente` VARCHAR(45) NULL,
  `whatsAppDoRequerente` VARCHAR(11) NULL,
  `emailDoRequerente` VARCHAR(100) NULL,
