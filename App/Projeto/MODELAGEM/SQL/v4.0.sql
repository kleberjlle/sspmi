...
CREATE TABLE IF NOT EXISTS `sspmi`.`usuario` (
  ...
  `setor_coordenacao_idcoordenacao` INT NULL,
  `coordenacao_idcoordenacao` INT NULL,
  `coordenacao_departamento_iddepartamento` INT NULL,
  `departamento_iddepartamento` INT NULL,
  `departamento_secretaria_idsecretaria` INT NULL,
  `secretaria_idsecretaria` INT NOT NULL,
  `telefone_idtelefone` INT NULL,
  PRIMARY KEY (`idusuario`, `secretaria_idsecretaria`),
  UNIQUE INDEX `idusuario_UNIQUE` (`idusuario` ASC),
  UNIQUE INDEX `email_UNIQUE` (`email` ASC),
  INDEX `fk_usuario_setor1_idx` (`setor_idsetor` ASC, `setor_coordenacao_idcoordenacao` ASC),
  INDEX `fk_usuario_coordenacao1_idx` (`coordenacao_idcoordenacao` ASC, `coordenacao_departamento_iddepartamento` ASC),
