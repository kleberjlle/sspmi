...
-- -----------------------------------------------------
-- Table `sspmi`.`permissao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`permissao` (
...
CREATE TABLE IF NOT EXISTS `sspmi`.`usuario` (
  ...
  CONSTRAINT `fk_usuario_permissao1`
    ...
    REFERENCES `sspmi`.`permissao` (`idpermissao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sspmi`.`historico` (
  ...
  `nomeDoDispositivo` VARCHAR(100) NOT NULL,
...
-- -----------------------------------------------------
-- Table `sspmi`.`prioridade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`prioridade` (
...
-- -----------------------------------------------------
-- Table `sspmi`.`protocolo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`protocolo` (
  ...
  CONSTRAINT `fk_protocolo_prioridade1`
    ...
    REFERENCES `sspmi`.`prioridade` (`idprioridade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sspmi`.`categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`categoria` (
...
-- -----------------------------------------------------
-- Table `sspmi`.`sistemaOperacional`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`sistemaOperacional` (
...
-- Table `sspmi`.`tensao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`tensao` (
...
-- -----------------------------------------------------
-- Table `sspmi`.`corrente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`corrente` (
...
-- -----------------------------------------------------
-- Table `sspmi`.`ambiente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`ambiente` (
...
-- Table `sspmi`.`local`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`local` (
...
-- -----------------------------------------------------
-- Table `sspmi`.`equipamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`equipamento` (
...
-- Table `sspmi`.`etapa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`etapa` (
  ...
  CONSTRAINT `fk_etapa_equipamento1`
    ...
    REFERENCES `sspmi`.`equipamento` (`idequipamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_etapa_protocolo1`
    FOREIGN KEY (`protocolo_idprotocolo`)
    REFERENCES `sspmi`.`protocolo` (`idprotocolo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `sspmi`.`marca`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`marca` (
...
-- Table `sspmi`.`modelo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`modelo` (
  ...
  CONSTRAINT `fk_modelo_marca1`
    ...
    REFERENCES `sspmi`.`marca` (`idmarca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sspmi`.`categoria_has_marca`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sspmi`.`categoria_has_marca` (
  `categoria_idcategoria` INT NOT NULL,
